...
def getGraphDistMatrix(adj_mat_set,filename,method):
    graph_num = len(adj_mat_set)
#    graph_dist_matrix = np.zeros((graph_num,graph_num))
    graph_dist_matrix_fast = np.zeros((graph_num,graph_num))
...
#    print np.linalg.norm(graph_dist_matrix - graph_dist_matrix_fast)/graph_num
    pickle.dump(graph_dist_matrix_fast,open(filename,'wb'))
