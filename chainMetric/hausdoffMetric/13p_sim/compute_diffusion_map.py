# -*- coding: utf-8 -*-
"""
Created on Tue Oct 20 10:46:06 2015
...
def compute_diffusion_map(L, alpha=0.5, n_components=None,
...
#        n_components = n_components_auto
    embedding = vectors[:, 1:(n_components + 1)]
#    for i in range(n_components):
#        embedding[:,i] = embedding[:,i] * lambdas[i+1]

    result = dict(vectors=vectors,
                  n_components=n_components)
    result['eigenvalues'] = lambdas
